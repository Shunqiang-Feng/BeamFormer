"""
Figure 21: Impact of model parameters (ablation study).
...
def plot(data, save_path):
    ...
    ablation_data = [
        ...
        # dim
        {
            ...
            "128": _get_rss_error(ablation_df["Dim-128"]),
            "64": _get_rss_error(ablation_df["Dim-64"]),
        },
        # Depth
        {
        ...
        # latent-num
        {
            ...
            "8": _get_rss_error(ablation_df["Latent-8"]),
            "4": _get_rss_error(ablation_df["Latent-4"]),
            "2": _get_rss_error(ablation_df["Latent-2"]),
        },
    ]
