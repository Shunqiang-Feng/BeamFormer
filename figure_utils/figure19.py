"""
Figure 19: Example spectrum with Sivers SDR.
...
# Default data path for Figure 19
...
def plot(save_path, pkl_path=None):
    """
    Plot Figure 19: Sivers SDR spectrum example.
    ...
    print(f"[Figure 19] Generating Sivers spectrum from: {pkl_path}")
