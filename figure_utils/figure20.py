"""
Figure 20: Example spectrum with IBM SDR.
...
# Default data path for Figure 20
...
def plot(save_path, experiment_path=None):
    """
    Plot Figure 20: IBM SDR spectrum example.
    ...
    print(f"[Figure 20] Generating IBM spectrum from: {experiment_path}")
