...
config = SimpleNamespace(
    ...
    dataset = dataset.ibm_indoor(add_noise = True,  snr_min = -5),
    estimator = estimator.PerceiverIO(estimator_pretrained_model="saved_models/ibm_random_32/estimator_epoch_final.pth"),
